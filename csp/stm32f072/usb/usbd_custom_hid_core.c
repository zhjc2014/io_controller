...
USBD_Class_cb_TypeDef  USBD_HID_cb = 
{
  ...
  NULL,//usbd_hid_SOF, /*SOF */    
  USBD_HID_GetCfgDesc, 
};


extern kfifo_t hid_rx_fifo;
extern kfifo_t hid_tx_fifo;
                                  ...
                                  uint8_t epnum)
{
  ...
  kfifo_push_in(&hid_rx_fifo,&Report_buf[1],Report_buf[0]);
