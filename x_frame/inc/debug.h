...
#define DBG_I(fmt, args...)                                                                                                 \
	do                                                                                                                      \
	{                                                                                                                       \
		if (flag_enable_cpf == 0)                                                                                           \
		{                                                                                                                   \
			PRINTF_FUNC(FIX_PARAM, _FILE_INFO _PREFIX_I fmt _APPEND_FIX, _FILE_INFO_ARG, ##args);                           \
		}                                                                                                                   \
		else                                                                                                                \
		{                                                                                                                   \
			PRINTF_FUNC(FIX_PARAM, "%s" _FILE_INFO _PREFIX_I fmt COLOR_END _APPEND_FIX, COLOR_GRE, _FILE_INFO_ARG, ##args); \
		}                                                                                                                   \
	} while (0)
#define DBG_I_STRP(fmt, args...)                             \
	do                                                       \
	{                                                        \
		PRINTF_FUNC(FIX_PARAM, fmt, _FILE_INFO_ARG, ##args); \
		PRINTF_FUNC(FIX_PARAM, "\r\n");                      \
	} while (0)
...
#define DBG_W(fmt, args...)                                                                                                 \
	...
	{                                                                                                                       \
		if (flag_enable_cpf == 0)                                                                                           \
		{                                                                                                                   \
			PRINTF_FUNC(FIX_PARAM, _FILE_INFO _PREFIX_W fmt _APPEND_FIX, _FILE_INFO_ARG, ##args);                           \
		}                                                                                                                   \
		else                                                                                                                \
		{                                                                                                                   \
			PRINTF_FUNC(FIX_PARAM, "%s" _FILE_INFO _PREFIX_W fmt COLOR_END _APPEND_FIX, COLOR_YEL, _FILE_INFO_ARG, ##args); \
		}                                                                                                                   \
	} while (0)
...
#define DBG_E(fmt, args...)                                                                                                 \
	...
	{                                                                                                                       \
		if (flag_enable_cpf == 0)                                                                                           \
		{                                                                                                                   \
			PRINTF_FUNC(FIX_PARAM, _FILE_INFO _PREFIX_E fmt _APPEND_FIX, _FILE_INFO_ARG, ##args);                           \
		}                                                                                                                   \
		else                                                                                                                \
		{                                                                                                                   \
			PRINTF_FUNC(FIX_PARAM, "%s" _FILE_INFO _PREFIX_E fmt COLOR_END _APPEND_FIX, COLOR_RED, _FILE_INFO_ARG, ##args); \
		}                                                                                                                   \
	} while (0)
