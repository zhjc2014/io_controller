...
#define FLUSH_TX        0xE1    //清除TX FIFO寄存�?，发射模式下使�??
#define FLUSH_RX        0xE2    //清除RX FIFO寄存�?，接收模式下使�??
...
#define CONFIG          0x00    //配置寄存器地址，bit0:1接收模式,0发射模式;bit1:电选择;bit2:CRC模式;bit3:CRC使能;
                                //bit4:�?断MAX_RT(达到最大重发�?�数�?�?使能;bit5:�?断TX_DS使能;bit6:�?断RX_DR使�    	
...
#define RF_SETUP        0x06    //RF寄存�?，bit3:传输速率( 0:1M 1:2M);bit1~2:发射功率;bit0:�?声放大器增�??
...
#define RX_ADDR_P0      0x0A    //数据通道0接收地址，最大长�?�?字节，低字节在�??
#define RX_ADDR_P1      0x0B    //数据通道1接收地址，最大长�?�?字节，低字节在�??
