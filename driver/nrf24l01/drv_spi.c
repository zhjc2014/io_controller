...
void drv_spi_init( void )
{
	...
	if( SPI1 == SPI_PORT )				
	{   
		RCC_APB2PeriphClockCmd( SPI_PORT_CLK, ENABLE );			//SPI1在APB2上，打开相应SPI时钟 72M
	}
	else
	{
		RCC_APB1PeriphClockCmd( SPI_PORT_CLK, ENABLE );			//SPI2 3在APB1上    36M
	}
	...
	SpiInitStructer.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_32;	//32分频
