...
#define MPU6500
#define MOTION_DRIVER_TARGET_STM32F072
...
#include "mpu6500.h"
#include "debug.h"
#define i2c_write(a, b, c, d)   mympu_write(a, b, c, d)
#define i2c_read(a, b, c, d)    mympu_read(a, b, c, d)
#define log_i(fmt,args...)      DBG_I(fmt, ##args)
#define log_e(fmt,args...)      DBG_E(fmt, ##args)
#define labs                    abs
#define fabs(x)                 (((x)>0)?(x):-(x))
#define min(a,b)                ((a)<(b)?(a):(b))
#endif
